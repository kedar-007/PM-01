      ...
      basicIO.write(
        JSON.stringify({
          ...
          user_details: {
            ...
            role_identifier: user_details.role_identifier, // If you want to override the default role, you can specify the role id/name here.
            org_id: user_details.org_id, // If you are providing the Org ID, make sure it is copied exactly from the console.
          },
        })
      );
    } else {
